define('index', ['defer'], function(require) {
...
define('comp-novelList',function (require, exports, module) {
  module.exports = require('$Compenent')({
    tpl: '<li class="comp-novelist">novellist</li>',
    css: '.comp-novelist{color:red;}'
  });
})

define('comp-novel',function (require, exports, module) {
  module.exports = require('$Compenent')({
    tpl: '<ul class="comp-novel"><%= this.require("comp-novelList") %></ul>',
    css: '.comp-novel{background:black;}'
  });
})
